...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  21.64,  21.73 }
    #define DEFAULT_Ki_LIST {   1.96,   1.54 }
    #define DEFAULT_Kd_LIST {  59.84,  76.55 }
  #else
    #define DEFAULT_Kp  21.64
    #define DEFAULT_Ki   1.96
    #define DEFAULT_Kd  59.84
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 92.96
  #define DEFAULT_bedKi 18.43
  #define DEFAULT_bedKd 312.64
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.4, -10.2, -1 }
